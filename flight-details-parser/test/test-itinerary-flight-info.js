...
describe('itinerary flight info tests', function() {
  function verifyFirstConnection(result) {
    ...
    expect(result.flight_schedule.arrival_time).to.equal("2017-5-1T14:15");
    expect(result.flight_schedule.departure_time).to.equal("2017-5-1T10:10");
    expect(result.flight_schedule.boarding_time).to.equal("2017-5-1T09:15");
  }
